...
description: "The OKF self-update workflow. When the user makes an architectural / naming / stack decision in chat, capture it as a concept file before the conversation ends."
...
conversation**. This is the [self-update rule](../rules/self-update-rule.md)
made operational.
