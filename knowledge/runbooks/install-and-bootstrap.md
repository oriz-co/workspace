...
description: "The chirag127/oriz family is one umbrella git repo that submodules every site, app, package, API, extension, and skill. The user always works from `c:/D/oriz/`. This runbook is the canonical fresh-clone and existing-clone-update procedure."
tags: [runbook, install, workspace, pnpm, submodule, bootstrap]
