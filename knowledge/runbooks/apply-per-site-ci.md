...
tags: [runbook, ci, github-actions, cloudflare-pages, dependabot, codeql, coderabbit, sonarcloud, biome]
...
| `projects/apps/personal/oriz-cs-me-app` | `chirag127/oriz-cs-me-app` |
...
(per [`rules/parallel-fan-out-by-default.md`](../rules/parallel-fan-out-by-default.md)):
...
Per [`rules/conventional-commits.md`](../rules/conventional-commits.md):
...
- [`../rules/parallel-fan-out-by-default.md`](../rules/parallel-fan-out-by-default.md)
