...
description: "One-shot audit of every GitHub App installed on the chirag127 account, surfaced via check-suite enumeration. Each row: app slug, observed activity, recommendation (KEEP/REMOVE/REVIEW). No auto-uninstall — humans pull the trigger."
tags: [runbook, github-apps, audit, security, free-tier]
timestamp: 2026-06-22
format_version: okf-v0.1
status: active
related:
  - runbooks/install-github-apps
  - runbooks/dependabot-notification-tuning
