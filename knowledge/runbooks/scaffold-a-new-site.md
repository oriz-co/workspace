...
description: "Step-by-step to add a new Astro site to the family in <10 minutes. Clones starter, edits 4 config files, registers as workspace submodule, deploys to Cloudflare Pages."
tags: [runbook, scaffold, astro, site, workspace]
...
- Site role decided (longform / catalog / hub / tool — see [sidebar-4-tier](../decisions/architecture/sidebar-4-tier.md))
