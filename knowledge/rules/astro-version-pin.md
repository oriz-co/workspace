...
description: "Every package.json across the family pins Astro at the current major via caret. Minors+patches auto-update weekly. Major upgrades happen via single workspace-wide PR."
