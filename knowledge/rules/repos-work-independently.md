...
description: "Cloning any single oriz submodule directly must give a fully working dev environment. The umbrella oriz repo orchestrates; it does not own the code. A solo clone of any site must pnpm install + pnpm build successfully without the master repo."
tags: [rule, repos, submodules, independence, ci]
...
- [`../runbooks/clean-install.md`](../runbooks/clean-install.md) — full-family bootstrap that doesn't violate this rule
