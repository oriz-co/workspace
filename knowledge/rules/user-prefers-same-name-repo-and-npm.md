...
description: "When a project ships as a GitHub repo + npm package, the slugs match (modulo @chirag127/ scope). No divergence. Subdomains stay independent."
tags: [taste, mcq-learned, naming, npm, github]
timestamp: 2026-06-20
related: [user-prefers-atomic-split, family-naming-policy]
---
