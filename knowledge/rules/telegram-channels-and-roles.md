...
description: "Telegram restored in India 2026-06-22. Four channels in the Oriz namespace: @oriz_announcements (public broadcast), @oriz_drafts (private drafts queue), @oriz_ops (private errors+CI), @oriz_paisa (public India finance). Drafts dual-write to TG + GH Issues for redundancy. Pairs with Substack for long-form newsletter (both used)."
