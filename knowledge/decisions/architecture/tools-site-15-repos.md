...
description: "Each tool category is its own GitHub repo (pdf-site, image-site, ...) deployed to its own Cloudflare Pages project at <category>.oriz.in. No tools-site monorepo. Picked over 'one repo, 15 subdomain builds' for portfolio framing and SEO concentration."
tags: [architecture, tools, repos, seo]
...
Tools sites use **Tier A: auto-generated** — the sidebar lists all tools in the current site, plus an "Other Oriz tools" section linking to the other 14 subdomains. See [sidebar-4-tier.md](./sidebar-4-tier.md).
