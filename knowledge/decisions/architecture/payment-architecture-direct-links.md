...
100K/day free envelope ([`cf-worker-quota-mitigation.md`](./cf-worker-quota-mitigation.md)).
...
- **No Firebase Functions needed** (see
  [`no-firebase-functions.md`](./no-firebase-functions.md)). The CF
...
- **Click-tracking is real.** Knowing which referrer / blog post /
  ...
  [`revenue-channels-2026.md`](./revenue-channels-2026.md) attribution
