...
See full pipeline in [book-publish-pipeline.md](./book-publish-pipeline.md). Summary row here:
...
Status: **planning** (none have manuscripts yet). Locked names + scope in [book-publish-pipeline.md](./book-publish-pipeline.md):
