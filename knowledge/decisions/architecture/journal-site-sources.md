...
description: "journal-site (journal.oriz.in) mines the best features of Day One, Bear, Notion, Obsidian, and Logseq into one journaling experience. Big scope chosen knowingly; flagship-grade polish target."
...
Tier B — curated TOC + recent. See [sidebar-4-tier.md](./sidebar-4-tier.md). The curated TOC is the templates list + section navigation; "recent" is the last 5 entries.
