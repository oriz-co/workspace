...
description: "Final locks across auth providers (Google + GitHub + Email-link + Phone OTP + Apple + Twitter), Razorpay TEST mode first, wrangler dev for local webhooks, all polish items required (mobile-responsive + dark+light toggle + PWA + SEO + OG), discount stack (FOUNDER50 + LAUNCH30 + BLOG20 + STUDENT50), mutual 15% referral, 7-day money-back, no trial, GitHub Student Pack verification."
...
related:
  ...
  - runbooks/razorpay-paddle-subscriptions-setup
