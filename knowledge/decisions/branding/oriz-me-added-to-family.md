...
`projects/apps/personal/oriz-cs-me-app/`. It hosts at `me.oriz.in` and serves as Chirag's
...
- The site has its own v2 design brief at `knowledge/design/oriz-me.md` and its own per-app `knowledge/` bundle inside the submodule at `projects/apps/personal/oriz-cs-me-app/knowledge/`.
