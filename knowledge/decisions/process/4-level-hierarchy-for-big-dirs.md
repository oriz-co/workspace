...
- Per-app `knowledge/` bundles (e.g. `projects/apps/personal/oriz-cs-me-app/knowledge/`, inside each submodule) MAY adopt 4-level once they hit the same threshold. Until then, they stay flat.
