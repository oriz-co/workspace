...
description: Firebase Auth's custom domain auth.oriz.in is shared by every *.oriz.in subdomain and every Chrome/Firefox/Edge extension. One sign-in, one Firebase user, every surface.
tags: [architecture, auth, firebase, cross-site, extensions]
