...
description: The SQL shape the lifestream JSONL is normalised into for the Turso warm cache. Lives concretely in oriz-me but the contract is family-wide — any site reading lifestream events sees this shape.
tags: [architecture, schema, turso, sqlite, events, lifestream]
...
related:
  ...
  - architecture/layer-4-database-by-shape
---
...
detail and indexes belong in the per-app `knowledge/` bundle inside the cs-me-app submodule (`projects/chirag127/own/products/apps/personal/cs-me-app/knowledge/`) — this file
...
- The full data sharding picture → [layer-4-database-by-shape.md](layer-4-database-by-shape.md)
